export function attachTestingHooks({ getSnapshot, advanceByMs, resetToMenu, setDebugScore, setDebugSync }) {
  ...
  if (typeof setDebugSync === "function") {
    window.setDebugSync = (payload) => {
      setDebugSync(payload);
    };
  }
}
